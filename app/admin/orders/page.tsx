...
import { useGetOrdersQuery } from "@/redux/features/admin/adminSlice";
...
const OrdersDashboard = (props: Props) => {
  const { data, isSuccess, isLoading, error } = useGetOrdersQuery({});
  useEffect(() => {
    if (isSuccess) {
    ...
    <>
      ...
      {isLoading ? (
        ...
        <div className="w-flex-1 h-auto">
          <h1 className="text-3xl font-[500] hover:shadow-sm text-center cursor-default text-yellow-500">
            All Orders
          </h1>
